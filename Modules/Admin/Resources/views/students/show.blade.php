            ...
            <section class="content_mu pt-40 pl-20 pr-20">
                <div class="row">
                    <div class="col-md-12">
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="title_01 border-bottom">
                                        <h4><i class="lni lni-user f-60 hvr-wobble-vertical"></i> {{ $student->name }} </h4>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control form-control-lg hijri-picker"
                                                    placeholder="{{ $student->ClassRoom->count() }}">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                        ...
                        <a href="{{ route('students') }}" class="btn-green float-right hvr-wobble-horizontal mt-20">رجوع</a>
                    </div>
                </div>
            </section>
        </div>
