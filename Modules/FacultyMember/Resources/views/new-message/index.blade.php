                    ...
                    <div class="col-md-12">
                        <div class="body_content_mu" style="min-height: 480px;">
                            <div class="title_01 border-bottom">
                                <h4><i class="fa fa-envelope"></i> رسالة جديدة</h4>
                            </div>
                            {!! Form::model('', ['route' => ['store_message'], 'method' => 'post', 'files' => true]) !!}
                            @csrf
                            <br />
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-12">
                                    <div>المادة</div>
                                    <select required id="course" class="form-control form-control-lg"
                                    ...
                                    <div>الطالب</div>
                                    <select required id="student" name="to" class="form-control form-control-lg"
                                        style="border: 1px solid #dddddd; font-size: 14px;">
