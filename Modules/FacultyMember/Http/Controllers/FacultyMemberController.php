...
class FacultyMemberController extends UserBaseController
{
    /**
    ...
    public function index(Request $request)
    {
        ...
        if($request->ajax()){
            $view = view('facultymember::notifications',compact('notifications'))->render();
            return response()->json(['html'=>$view]);
        }
        return view('facultymember::index',compact('notifications'));
    }
    ...
    {
        return view('facultymember::show');
    }
